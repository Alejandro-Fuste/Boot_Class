...
import { ADD_POSTS, LOADING } from '../../utils/actions';
...
const CreatePostForm = () => {
	...
	const handleSubmit = (e) => {
		...
		API.savePost({
			...
			.then((result) => {
				dispatch({ type: ADD_POSTS, post: result.data });
			})
	...
	return (
		<div>
			...
			<form className="form-group mt-5 mb-5" onSubmit={handleSubmit}>
				...
				<button className="btn btn-success mt-3 mb-5" type="submit" disable={state.loading}>
					Save Post
				</button>
			</form>
		</div>
